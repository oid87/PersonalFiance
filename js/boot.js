    ...
    function computeKD(hlcData, period = 9) {
      const out = [];
      let K = 50, D = 50;
    ...
    function computeTDSetup(closeData) {
      const out = [];
      let uc = 0, dc = 0;
    ...
    function computeDDZones(dailyData, lookbackDays = 60, threshold = 0.10) {
